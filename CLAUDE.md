...
templates/               # 기본 양식 (report-template.hwpx 등)
references/              # 양식 스타일 가이드 (보고서, 공문서, XML 구조)
output/                  # 생성된 문서 출력
.claude/commands/
...
- 보고서 양식 참조: `references/report-style.md`
- 공문서 양식 참조: `references/official-doc-style.md`
- XML 내부 구조 참조: `references/xml-internals.md`
- 기본 보고서 템플릿: `templates/report-template.hwpx`
